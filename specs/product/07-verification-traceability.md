...
| `OPS-005`, `OPS-006` | `tools/vpsguard_harness/release_lifecycle.py`, `scripts/update-release.sh`, `scripts/tests/repository-contracts.sh`, `scripts/uninstall.sh` | [`OPS-005` 2GB VM 20회 update·restore와 100ms public probe](evidence/gnuboard5-release-endurance-20260724.md); `OPS-006` 실제 uninstall 증거는 미수집 |
