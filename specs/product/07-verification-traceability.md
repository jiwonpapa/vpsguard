...
| `DET-014` | `crates/guard-agent/tests/os_collector.rs`, `crates/guard-core/src/detection/tests.rs`, `crates/guard-control/src/runtime/tests.rs`, `tools/tests/test_host_pressure.py` | `tools/vpsguard_harness/host_pressure.py`의 2GB VPS `/proc`·Control API 대조와 synthetic pressure 상태 전이 timeline |
