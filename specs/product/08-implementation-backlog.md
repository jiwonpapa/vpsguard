...
- [ ] 위험 method 거부, typed response header와 origin version header 제거
- [ ] profile auth 경로의 bounded client별 시도 한도와 G7 교차 profile 회귀
- [ ] query·body 비밀값 log scan, 관리 status·UI 보안 posture 표시
