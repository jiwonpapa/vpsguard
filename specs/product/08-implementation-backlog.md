...
- 요구사항: `NFR-001`
- [x] 동일 50 VU·15초 workload의 direct-origin과 release guard-edge를 순차 측정
...
- [ ] 2026-07-24 수정 후 로컬 release 2회 측정도 p95 `+1.796ms`/`+2.189ms`, 처리량 `-21.57%`/`-25.02%`로 예산 미달
- [ ] 동일 2GB Ubuntu 서버의 direct Nginx 비교·원인 최적화·예산 통과 증거
