...
`OPS-005`와 `OPS-010`의 20회 update·restore와 100ms public probe는 이후
[2GB release 내구성 실증](gnuboard5-release-endurance-20260724.md)에서
통과해 **VPS_PASS**로 승격했습니다.
...
- 이 문서 자체는 한 번의 x86_64 update·policy·restore 파일럿입니다.
  20회 release 내구성은 별도 운영 증거에서 검증했습니다.
