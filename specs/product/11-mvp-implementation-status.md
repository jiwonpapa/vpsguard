...
현재 요구사항 123개 중 `PLANNED` 1개, `CODE_ONLY` 30개, `AUTO_PASS` 73개, `VPS_PASS` 19개입니다. 즉 122개는 코드 또는 계약이 존재하며 자동 수용 기준까지 통과한 것은 92개입니다. `VPS_PASS`는 보존된 운영 증거 수준이며 요구사항 전체의 release 완료를 뜻하지 않습니다.
