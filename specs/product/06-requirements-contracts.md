...
| `NFR-010` | 개발·CI Cargo 산출물의 디스크 사용을 bounded profile과 안전한 정리 하네스로 제한 | dev/test incremental 비활성·dependency debug 정보 제거 gate, repository `target` 경계 검증, 재생성 가능 cache 정리와 release bundle·검증 evidence 보존 unit test 통과 |
